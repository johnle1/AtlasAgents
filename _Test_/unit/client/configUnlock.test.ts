...
describe("config.ts — encryption at rest", () => {
  ...
  let lockCipher: typeof import("../../../packages/client/src/crypto/configCipher.js").lockCipher;
  let ConfigDecryptionError: typeof import("../../../packages/client/src/crypto/configCipher.js").ConfigDecryptionError;
  ...
  beforeAll(async () => {
    ...
    const cipherMod = await import("../../../packages/client/src/crypto/configCipher.js");
