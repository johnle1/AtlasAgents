/**
 * Unit tests — advisor think-block parsers (SELF-CHECK, plan sections).
 */

import { describe, expect, it } from "vitest";
import { parseVerifyGaps } from "../../packages/server/src/orchestration/advisor/advisorThink.js";
...
SELF-CHECK:
  ...
  it("still treats legacy TASK SIZE trivial as trivial", () => {
    const legacyTrivial = `<advisor-think>
TASK SIZE: trivial
PLAN:
  agent count: 1
  execution: sequential
